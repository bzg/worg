...
* Headlines and Sections
  ...
  will be considered as "commented".  If that first word is "QUOTE",
  it will be considered as "quoted".  In both situations, case is
  significant.
...
** Clock, Diary Sexp and Planning
   ...
   A planning is a line filled with at most three INFO parts, where
