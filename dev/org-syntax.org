...
A core concept in this syntax is that only headlines, sections and
planning lines are context-free[fn:1][fn:2].  Every other syntactical
...
** Drawers and Property Drawers
   ...
   In a property drawer, CONTENTS can only contain [[#Node_Properties][node property]]
...
** Clock, Diary Sexp and Planning
   ...
   where PLANNING is a line filled with at most three INFO parts,
   where each of them follows the pattern:
...
lines can be recognize by looking at the beginning of the current line
