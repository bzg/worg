...
You can either either prepare patches with =[[http://www.kernel.org/pub/software/scm/git/docs/git-format-patch.html][git format-patch]]= or send
them directly with =[[http://www.kernel.org/pub/software/scm/git/docs/git-send-email.html][git send-email]]=.
