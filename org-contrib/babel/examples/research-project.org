...
** Documents
    ...
    easiest to let outline the structure of the paper down to the
    level of the paragraph so that the leaves of the Org-mode tree are
    paragraph topic sentences.  This is a bit of work, made easier by
    YASnippets for Org-babel code blocks and frequently used Beamer
    constructs, but I find that the outlining process is a great aid
