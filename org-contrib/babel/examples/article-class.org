...
#+LaTeX_CLASS_OPTIONS: [koma,a3paper,DIV=15,landscape,twocolumn,palatino,10pt,listings-sv,microtype,paralist]
...
In the third example, the following two lines appeared at the top of
the Org-mode file:
