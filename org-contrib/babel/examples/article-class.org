...
#+LaTeX_CLASS_OPTIONS: [article,letterpaper,landscape,times,12pt,listings,listings-bw,color,microtype,paralist]
...
#+LaTeX_CLASS: org-article-subsubsection
#+LaTeX_CLASS_OPTIONS: [article,letterpaper,times,12pt,listings,listings-bw,color,microtype]
#+end_src
...
#+begin_src latex :exports code
#+LaTeX_CLASS: org-article-subsubsection
#+LaTeX_CLASS_OPTIONS: [koma,a5paper,landscape,utopia,10pt,listings,color,listings-color,microtype,paralist]
#+end_src
