...
The numerous options that [[latex:classfile][Org-article]] would need to support turn out
to be the Achilles heel of the design decision to encapsulate the
interface between LaTeX and [[latex:proglang][Org-mode]] in a LaTeX class file.  Toss in
