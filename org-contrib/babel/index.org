...
- [[https://orgmode.org/manual/Working-with-Source-Code.html][Reference and Documentation]]: is available online and in Chapter 14
  ...
  and result types for Babel code blocks can be found [[https://orgmode.org/manual/Header-arguments.html#Header-arguments][here]].
- [[file:languages/index.org][Languages]]: list of supported languages with information on
