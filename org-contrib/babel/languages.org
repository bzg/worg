...
|----------------------+-----------------+------------------------------------------------+----------|
| [[file:languages/ob-doc-abc.org][ABC]]                  | =abc=           | [[http://moinejf.free.fr/][abcm2ps]], [[https://github.com/mkjunker/abc-mode][abc-mode]]                              | core     |
| [[file:languages/ob-doc-asymptote.org][Asymptote]]            | =asymptote=     | [[http://asymptote.sourceforge.net/][asymptote]], [[http://asymptote.sourceforge.net/doc/Editing-modes.html][asy-mode]]                            | core     |
| [[file:languages/ob-doc-awk.org][Awk]]                  | =awk=           | awk                                            | core     |
...
| [[file:languages/ob-doc-C.org][C]]                    | =C=             | none                                           | core     |
| [[file:languages/ob-doc-C.org][C++]]                  | =cpp=           | none                                           | core     |
| Calc                 | =calc=          | none                                           | core     |
| [[file:languages/ob-doc-clojure.org][Clojure]]              | =clojure=       | [[http://clojure.org/][Clojure]], [[https://github.com/clojure-emacs/clojure-mode][Clojure Mode]], [[https://github.com/clojure-emacs/cider][CIDER]], [[http://leiningen.org/][Leiningen]]        | core     |
| comint               | =comint=        |                                                | core     |
| Coq                  | =coq=           |                                                | core     |
| [[file:languages/ob-doc-css.org][CSS]]                  | =css=           | none                                           | core     |
| [[file:languages/ob-doc-C.org][D]]                    | =D=             | [[http://dlang.org][D]]                                              | core     |
| [[file:languages/ob-doc-ditaa.org][Ditaa]]                | =ditaa=         | [[http://ditaa.org/ditaa/][ditaa]] (bundled with Org-mode)                  | core     |
...
| [[file:languages/ob-doc-eukleides.org][Eukleides]]            | =eukleides=     | [[http://eukleides.org/][eukleides]]                                      | contrib  |
...
| [[file:languages/ob-doc-gnuplot.org][Gnuplot]]              | =gnuplot=       | [[http://www.gnuplot.info/][gnuplot]], [[http://cars9.uchicago.edu/~ravel/software/gnuplot-mode.html][gnuplot-mode]]                          | core     |
...
| Io                   | =io=            |                                                | core     |
| [[https://github.com/gregsexton/ob-ipython][iPython]]              | =ipython=       | [[file:languages/ob-doc-python.org][ob-python]]                                      | package  |
| [[file:languages/ob-doc-J.org][J]]                    | =J=             | [[http://www.jsoftware.com/][J]], [[https://github.com/zellio/j-mode][j-mode]]                                      | core     |
| [[file:languages/ob-doc-java.org][Java]]                 | =java=          | java                                           | core     |
...
| [[file:languages/ob-doc-LaTeX.org][LaTeX]]                | =latex=         | [[http://www.latex-project.org/][latex]], [[http://www.gnu.org/software/auctex/][auctex]], [[http://www.gnu.org/software/auctex/reftex.html][reftex]]                          | core     |
| [[file:languages/ob-doc-ledger.org][Ledger]]               | =ledger=        | [[http://wiki.github.com/jwiegley/ledger/][ledger]]                                         | core     |
| [[file:languages/ob-doc-lilypond.org][Lilypond]]             | =ly=            | [[http://lilypond.org/][lilypond music notation]]                        | core     |
| [[file:languages/ob-doc-lisp.org][Lisp]]                 | =lisp=          | lisp, [[http://common-lisp.net/project/slime/][slime]]                                    | core     |
| Lisp Flavored Erlang | =lfe=           | [[http://lfe.io/][lfe]]                                            | package  |
| [[file:languages/ob-doc-makefile.org][Make]]                 | =makefile=      | none                                           | core     |
| Mathematica          | =mathematica=   |                                                | contrib  |
| [[file:languages/ob-doc-mathomatic.org][Mathomatic]]           | =mathomatic=    | [[http://www.mathomatic.org][Mathomatic]]                                     | contrib  |
| [[file:languages/ob-doc-octave-matlab.org][Matlab]]               | =matlab=        | matlab, [[http://sourceforge.net/projects/matlab-emacs/][matlab.el]]                              | core     |
| [[file:languages/ob-doc-maxima.org][Maxima]]               | =max=           | [[http://maxima.sourceforge.net/][maxima]], Common Lisp, gnuplot (optional)        | core     |
| [[https://github.com/krisajenkins/ob-mongo][MongoDB]]              | =mongo=         | [[https://www.mongodb.org/][mongoDB]]                                        | package  |
| [[file:languages/ob-doc-mscgen.org][Mscgen]]               | =mscgen=        | [[http://www.mcternan.me.uk/mscgen/][Mscgen]]                                         | core     |
...
| [[file:languages/ob-doc-octave-matlab.org][Octave]]               | =octave=        | octave                                         | core     |
| Org                  | =org=           | none                                           | core     |
| [[file:languages/ob-doc-oz.org][OZ]]                   | =oz=            | [[http://www.mozart-oz.org/][Mozart]] which includes a major mode             | contrib  |
| Perl                 | =perl=          | [[http://www.perl.org/][perl]], [[http://www.emacswiki.org/emacs/CPerlMode][cperl-mode]] (optional)                    | core     |
| [[file:languages/ob-doc-picolisp.org][Picolisp]]             | =picolisp=      | [[http://picolisp.com/5000/!wiki?home][PicoLisp]]                                       | core     |
...
| [[file:languages/ob-doc-python.org][Python]]               | =python=        | [[http://www.python.org/][python]], [[https://launchpad.net/python-mode][python-mode]] (optional)                 | core     |
| [[file:languages/ob-doc-R.org][R]]                    | =R=             | [[http://www.r-project.org/][R]], [[http://ess.r-project.org/][ess-mode]], [[http://cran.r-project.org/web/packages/tikzDevice/index.html][tikzDevice]]                        | core     |
...
| [[file:languages/ob-doc-screen.org][Screen]]               | =screen=        |                                                | core     |
| Sed                  | =sed=           |                                                | core     |
...
| [[file:languages/ob-doc-sql.org][SQL]]                  | =sql=           | an RDBMS                                       | core     |
| [[file:languages/ob-doc-sqlite.org][SQLite]]               | =sqlite=        | [[http://www.sqlite.org/index.html][SQLite]], [[http://www.sqlite.org/sqlite.html][sqlite3]], [[http://www.emacswiki.org/emacs/SqlMode][SQL mode]]                      | core     |
| [[file:languages/ob-doc-stan.org][Stan]]                 | =stan=          | [[http://mc-stan.org/][Stan]], [[https://github.com/stan-dev/stan-mode][Stan mode]]                                | core     |
...
| [[file:languages/ob-doc-stata.org][Stata]]                | =stata=         | [[http://stata.com/][Stata]], [[http://ess.r-project.org/][ess-mode]]                                | contrib  |
| [[file:languages/ob-doc-tcl.org][Tcl]]                  | =tcl=           | [[http://www.tcl.tk/][tclsh]]                                          | contrib  |
...
| [[file:languages/ob-doc-vala.org][Vala]]                 | =vala=          | [[https://wiki.gnome.org/Projects/Vala][Vala]]                                           | core     |
