...
| HTML                 | browser     |                      | [[http://phantomjs.org/][PhantomJS]], ob-browser.js                        |
| Neo4j                | cypher      |                      | [[http://neo4j.com/][neo4j]], [[https://github.com/fxbois/cypher-mode][cypher-mode]]                              |
| http request         | http        | [[https://github.com/zweifisch/ob-http][ob-http on github]]    | [[http://curl.haxx.se/][cURL]]                                                |
| iPython              | ipython     |                      | [[file:languages/ob-doc-python.org][ob-python]]                                                       |
| Kotlin               | kotlin      |                      | [[http://kotlinlang.org/][Kotlin]], [[https://github.com/quantumman/emacs.d/blob/master/auto-install/kotlin-mode.el][kotlin-mode]]                             |
| Lisp Flavored Erlang | lfe         |                      | [[http://lfe.io/][lfe]]                                             |
| MongoDB              | mongo       |                      | [[https://www.mongodb.org/][mongoDB]]                                         |
...
| Google Translate     | translate   |                      | [[https://github.com/atykhonov/google-translate][google-translate]]                                |
| Typescript           | typescript  |                      | [[https://nodejs.org/][node.js]], [[https://www.npmjs.com/package/typescript][typescript]]                             |
