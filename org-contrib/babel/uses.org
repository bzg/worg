...
data are held in [[http://repo.or.cz/w/Worg.git/blob_plain/HEAD:/org-contrib/babel/examples/r/*.csv][external files]], rather than as Org-mode tables.  The
...
control the look and feel of the resulting pdf file.
