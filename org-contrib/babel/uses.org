...
* [[file:examples/data-collection-and-analysis/data-collection-analysis.org][Data Collection and Analysis]]
...
* [[file:examples/latex-form/latex-form.org][A LaTeX Form]]
...
* [[file:examples/short-report/short-report.org][A Standardized Short Report]]
...
* [[file:examples/research-project/research-project.org][A Research Project]]
...
* [[file:examples/teaching-material/drift.org.html][Teaching material]]
  ...
  A good way to see how org-babel functioned to create the tutorial is
  to view the [[file:examples/teaching-material/drift.org.html][htmlized org buffer]]. This also provides an example of
  how images and latex-generated mathematical notation can be viewed
  inline in emacs. The HTML export version is [[file:examples/teaching-material/drift.org][here]].
