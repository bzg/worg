...
* Overview
  ...
  - Using source blocks in Org mode ::
       If you are not familiar with creating source blocks in an Org
  ...
  - Executing code ::
       The core of Babel is its ability to execute code in Org
...
* The Library of Babel
  ...
  As we saw with the [[*Using a Code Block as a Function][square]] example, once a source block function has
...
# hello-world ends here
    ...
    calling source code block functions (see the [[#library-of-babel][Library of Babel]]). For example,
