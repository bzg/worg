...
In addition to passing data from tables as [[arguments-to-source-code-blocks][arguments]] to source code
...
What Org-babel adds is the ability to use source blocks (in whatever
