...
#+begin_src R :session :results output :exports (if (require 'ess) "both" "code")
  square <- function(x) {
    x * x
  }
  x <- 1:10 
...
#+begin_src R :exports (if (require 'ess) "both" "code")
  square(x)
#+end_src
...
#+begin_src R :session :exports (if (require 'ess) "both" "code")
  square(x)
#+end_src
