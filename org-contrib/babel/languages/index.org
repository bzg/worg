...
| [[file:ob-doc-dot.org][Dot (Graphviz)]]       | =dot=           | [[http://www.graphviz.org/][dot]]                                            | core     |
| ebnf                 | =ebnf=          | [[https://www.emacswiki.org/emacs/EbnfToPsPackage][ebnf2ps]]                                        | core     |
...
| [[file:ob-doc-eshell.org][eshell]]               | =eshell=        | eshell                                         | core     |
...
| [[file:ob-doc-haxe.org][Haxe]]                 | =haxe=          | [[https://haxe.org/][Haxe]]                                           | package  |
...
| [[file:ob-doc-java.org][Java]]                 | =java=          | [[https://openjdk.java.net/][Java]]                                           | core     |
| [[file:ob-doc-js.org][Javascript]]           | =js=            | [[http://nodejs.org/][node.js]]                                        | core     |
...
| [[file:ob-doc-perl.org][Perl]]                 | =perl=          | [[http://www.perl.org/][perl]], [[http://www.emacswiki.org/emacs/CPerlMode][cperl-mode]] (optional)                    | core     |
