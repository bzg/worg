...
| Key           | Binding                           |
|---------------+-----------------------------------|
| =C-c C-v C-a= | [[function-org-babel-sha1-hash][org-babel-sha1-hash]]               |
| =C-c C-v C-b= | [[function-org-babel-execute-buffer][org-babel-execute-buffer]]          |
| =C-c C-v C-f= | [[function-org-babel-tangle-file][org-babel-tangle-file]]             |
| =C-c C-v C-g= | [[function-org-babel-goto-named-source-block][org-babel-goto-named-source-block]] |
| =C-c C-v C-l= | [[function-org-babel-lob-ingest][org-babel-lob-ingest]]              |
| =C-c C-v C-p= | [[function-org-babel-expand-src-block][org-babel-expand-src-block]]        |
| =C-c C-v C-s= | [[function-org-babel-execute-subtree][org-babel-execute-subtree]]         |
| =C-c C-v C-t= | [[function-org-babel-tangle][org-babel-tangle]]                  |
| =C-c C-v C-z= | [[function-orb-babel-switch-to-session][org-babel-switch-to-session]]       |
| =C-c C-v a=   | [[function-org-babel-sha1-hash][org-babel-sha1-hash]]               |
| =C-c C-v b=   | [[function-org-babel-execute-buffer][org-babel-execute-buffer]]          |
| =C-c C-v f=   | [[function-org-babel-tangle-file][org-babel-tangle-file]]             |
...
| =C-c C-v p=   | [[function-org-babel-expand-src-block][org-babel-expand-src-block]]        |
...
| =C-c C-v z=   | [[function-orb-babel-switch-to-session][org-babel-switch-to-session]]       |
...
*** org-babel-expand-src-block
    :PROPERTIES:
    :CUSTOM_ID: function-org-babel-expand-src-block
    :END:
...
*** org-babel-switch-to-session
    :PROPERTIES:
    :CUSTOM_ID: function-orb-babel-switch-to-session
    :END:
#+begin_example 
