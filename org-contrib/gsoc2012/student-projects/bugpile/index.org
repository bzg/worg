...
/A bugtracker for Org-mode/
/written in Org-mode and Picolisp/

* Bugpile 
** About
Bugpile is a bugtracker for GNU Emacs Org-mode written in Org-mode
itself and PicoLisp. It is an example application for [[file:i.org][iOrg]], the
web-framework based on Org-mode, Git and PicoLisp.

It will be developed during the GSoC 2012. 
