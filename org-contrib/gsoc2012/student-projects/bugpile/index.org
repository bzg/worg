...
#+TITLE:      Bugpile - a bugtracker based on Org-mode and Picolisp
...
itself an PicoLisp. It is entirely Lisp-based and customized for the
needs of Emacs users. It will be developed during the GSoC 2012. 
