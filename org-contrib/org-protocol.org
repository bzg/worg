...
*** Which capture template is used?
    ...
    =org-capture-default-template= [fn:1].
...
#+end_src
  ...
  If you're now browsing http://orgmode.org/worg/org-contrib/org-protocol.html
...
[fn:1] Before commit =fc49c1ec96b2c789f573ae1ba936b930a8494402=, 3rd Sept. 2010,
if a template with the key string "=w=" was defined, this one was chosen by
default.  This was done to make bookmarks used for [[file:./org-annotation-helper.el][org-annotation-helper]] work
