...
- [[file:babel/org-babel.org][Org-babel -- execution of source code blocks]] ::
...
- [[file:org-git-link.org][/org-exp-bibtex.el/ -- Export bibtex fragments]] ::
...
- [[file:org-git-link.org][/org-git-link.el/ -- link to files under git version control]] ::
  ...
  Written by /Raimar Finken/.
  [[repofile:lisp/org-git-link.el][Link to raw file]].
...
- /org-git-link.el/ -- linking to specific git revisions of a file ::
