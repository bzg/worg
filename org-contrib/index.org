...
- [[file:org-annotation-helper][org-annotation-helper.el]] -- managing bookmarks \\
  Org-annotation-helper.el helps save references to web pages
  (bookmarks) by simply clicking a bookmarklet.
