...
Follow the instructions for setting up MELPA: https://melpa.org/#/getting-started
...
Open the file [[https://gitlab.com/phillord/org-drill/-/raw/master/spanish.org][spanish.org]]. Press =M-x= and run the function =org-drill=. Follow
...
external browser of your choice ([[https://orgmode.org/worg/org-contrib/org-protocol.php][org-protocol]]).
