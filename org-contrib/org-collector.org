...
described below.  Then download this @<a
href="http://orgmode.org/worg/sources/org-contrib/org-collector-example.org">example
file@</a>, which contains the following headlines/properties.
