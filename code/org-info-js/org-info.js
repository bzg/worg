...
}this.TAGS[n[d]].push(h);}}else{if(k[e].className.match(this.SECNUM_REGEX)){this.SECNUM_MAP[this.trim(k[e].innerHTML)]=this.NODE;
}}}}this.NODE.hide();return(m);}return(q);},build:function(){var f=this.TITLE.innerHTML;
