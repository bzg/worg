...
if(this.DEBUG>5){this.debug+=a+"\n";}}}return a;},removeOrgTags:function(a){if(a.match(this.ORGTAG_REGEX)){var b=this.REGEX.exec(a);
return b[1];}return a;},init:function(){this.runs++;this.BODY=document.getElementById("content");
...
c="Contents:<br /><ul>";for(var b=0;b<this.SECS[d].children.length;++b){c+='<li><a href="'+this.SECS[d].children[b].link+'">'+this.removeOrgTags(this.SECS[d].children[b].heading.innerHTML)+"</a></li>";
