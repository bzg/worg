...
}m.HOOKS.run_hooks=true;m.runHooks("onReady",null);},initFromTOC:function(){var k=this;
...
}else{b.N.D.scrollIntoView(true);}}}}c.setLinkClass();b.N.setLinkClass(true);b.runHooks("onShowSection",{last:c,current:b.N});
...
}else{if(e.SLIDE_VIEW==e.LVM){e.sV();}}e.ss(e.N.J);}},runHooks:function(b,a){if(this.HOOKS.run_hooks){for(var c=0;
c<this.HOOKS[b].length;++c){this.HOOKS[b][c](this,a);}}},addHook:function(a,b){this.HOOKS[a].push(b);
},onReady:function(a){this.addHook("onReady",a);},onShowSection:function(a){this.addHook("onShowSection",a);
...
if(b.shiftKey){org_html_manager.CI.value=org_html_manager.CI.value+a;}else{org_html_manager.CI.value=org_html_manager.CI.value+a.toLowerCase();
