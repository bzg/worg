...
c+=(d+1)+"</td></tr></table>";this.S[d].BS=document.createElement("div");this.S[d].BS.innerHTML='<div class="org-info-js_header-navigation" style="display:inline;float:right;text-align:right;font-size:70%;font-weight:normal;">'+this.LINKS+'<a accesskey="t" href="javascript:org_html_manager.toggleView('+d+');">toggle view</a></div>';
...
}else{b.W.innerHTML=b.N.NAV+b.N.D.innerHTML;}b.N.hide();if("?/toc/?"!=d){window.location.replace(b.BU+b.dT());
}document.body.focus();}else{if(!b.VIEW_BUTTONS){OrgNode.hE(c.BS);}OrgNode.sE(b.N.BS);
b.N.sSt(OrgNode.UNFOLDED);b.N.show();b.N.D.scrollIntoView(true);window.location.replace(b.BU+b.dT());
