...
}if("?/toc/?"!=d){window.location.replace(b.BU+b.dT());}if(!b.FIXED_TOC){OrgNode.sE(document.body);
}}else{if(!b.VIEW_BUTTONS){OrgNode.hE(c.BS);}OrgNode.sE(b.N.BS);b.N.sSt(OrgNode.UNFOLDED);
b.N.show();b.N.D.scrollIntoView(true);window.location.replace(b.BU+b.dT());}}}},pV:function(c){var b=this;
document.onclick=null;document.ondblclick=null;b.VIEW=b.PLAIN_VIEW;OrgNode.hE(b.W);
if(b.IT){OrgNode.hE(b.IT);}OrgNode.sE(b.T);if(b.W.firstChild){b.W.removeChild(b.W.firstChild);
