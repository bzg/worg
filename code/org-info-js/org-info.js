...
OrgNode.sE(b.D);break;default:OrgNode.sE(b.F);OrgNode.sE(b.D);}b.ST=c;};var org_html_manager={MOUSE_HINT:0,B:null,PLAIN_VIEW:0,CONTENT_VIEW:1,ALL_VIEW:2,INFO_VIEW:3,SLIDE_VIEW:4,VIEW:this.CONTENT_VIEW,LOCAL_TOC:false,LINK_HOME:0,LINK_UP:0,LINKS:"",RUN_MAX:1200,RUN_INTERVAL:100,HIDE_TOC:false,TOC_DEPTH:0,STARTUP_MESSAGE:0,P:null,BU:document.URL,R:null,N:null,T:null,IT:false,LOAD_CHECK:null,W:null,S:new Array(),REGEX:/(#)(.*$)/,SIDX:/(^#)(sec-\d[.\d]*$)/,UNTAGX:/<[^>]+>/i,ORGTAGX:/^(.*)<span\s+class=[\'\"]tag[\'\"]>(<span[^>]>[^<]<\/span>)+<\/span>/i,TRIMMER:/^(\s*)([^\s].*)(\s*)$/,TOC:null,RUNS:0,H:new Array(50),HI:0,SKIP_H:false,FIXED_TOC:false,C:null,CI:null,CL:null,CO:"50px",OCCUR:"",SCX:"",SC_HLX:new RegExp('(<span class="org-info-js_search-highlight">)([^<]*?)(</span>)',"gi"),Mg:0,MgI:1,MgT:2,Hg:false,Rg:false,RC:"",RC_NULL:"_0",RC_H:"_1",RC_O:"_2",RC_P:"_03",LVM:0,TAB_INDEX:1000,SHO:false,TAGS:{},ST:new Array(),TAGS_INDEX:null,CTO:null,SN_MAP:{},SECNUMX:/^section-number-(\d)+/,TL:null,setup:function(){var d=this;
...
document.onkeypress=OrgHtmlManagerKeyEvent;if(l.VIEW==l.INFO_VIEW){l.iV(d,1);}else{if(l.VIEW==l.SLIDE_VIEW){l.sV(d,1);
}else{var j=l.VIEW;l.pV(d,1);l.R.DRT=true;l.R_STATE=OrgNode.SU;l.tG();if(j>l.PLAIN_VIEW){l.tG();
}if(j==l.ALL_VIEW){l.tG();}}}l.ss(d,1);if(0==d||l.INFO_VIEW==l.VIEW){window.scrollTo(0,0);
...
break;}}}},ss:function(e,c){var b=this;var f=parseInt(e);var d=b.N;if(b.HIDE_TOC&&b.N==b.TOC&&!b.FIXED_TOC){OrgNode.hE(b.TOC.D);
if(b.PLAIN_VIEW==b.VIEW){b.R.sAC();for(var a=0;a<b.R.CH.length;++a){b.R.CH[a].ST=OrgNode.SU;
b.R.CH[a].fold();}}}if("?/toc/?"!=e&&null!=b.TL){b.TL.blur();}if("?/toc/?"==e||(!isNaN(f)&&b.S[f])){if("?/toc/?"==e&&b.HIDE_TOC){b.N=b.TOC;
...
}if(1!=c&&"?/toc/?"!=e){window.location.replace(b.BU+b.dT());}if(!b.FIXED_TOC){OrgNode.sE(document.body);
}}else{if(!b.VIEW_BUTTONS){OrgNode.hE(d.BS);}OrgNode.sE(b.N.BS);b.N.sSt(OrgNode.UNFOLDED);
b.N.show();b.N.D.scrollIntoView(true);if(1!=c){window.location.replace(b.BU+b.dT());
}}}}},pV:function(d,a){var c=this;document.onclick=null;document.ondblclick=null;
c.VIEW=c.PLAIN_VIEW;OrgNode.hE(c.W);if(c.IT){OrgNode.hE(c.IT);}OrgNode.sE(c.T);if(c.W.firstChild){c.W.removeChild(c.W.firstChild);
