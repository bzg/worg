...
[[file:~/Worg/org-glossary.org::#docstring][docstring]], the value =org-agenda-entry-types= is a list that consists
...
upcoming deadlines or a weekly or monthly calendar view that includes
only timestamps and diary sexps. The variable =org-agenda-entry-types=
