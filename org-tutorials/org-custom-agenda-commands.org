...
that display all headlines tagged "office" in the file "widgets.org",
...
could, for instance, tweak display options for sparse tree searches by
using the variables org-show-hierarchy-above and org-show-entry-below
