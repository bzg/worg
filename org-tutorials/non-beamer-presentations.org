...
1. Yann Hodique has developed a javascript based option which works
   ...
   [[http://www.hodique.info/blog/2009/11/14/s5_presentation_from_org-mode][s5_presentation_from_org-mode]].
...
- For an example of org-S5 in action, see [[http://cs.unm.edu/~eschulte/notes/s5/s5.html][this presentation]] which was
  exported from [[http://cs.unm.edu/~eschulte/notes/s5/s5.org][this Org-mode file]] using =org-export-as-s5= with the
  "railscast" theme.
