...
the slideshow is finished. Please check user variables for flexible control.

The code is available at [[https://github.com/takaxp/org-tree-slide][Github]]. Please use the following direct link:
...
You can find more detail in the lisp file.
