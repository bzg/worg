...
**** Exporting to LaTeX (by Eric S Fraga)
     ...
     2. The numbering of actions is done instead by explicitly putting
     ...
     argument to the action macro in the headline.  This, on export,
     will put that person's name or initials in the right margin of
     the page with a box around it, making it very easy to identify
     who has actions and who does not.
