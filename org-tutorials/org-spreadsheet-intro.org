...
#+TITLE:      Org as a spreadsheet system: introduction
#+AUTHOR:     Worg people
...
buffer by typing = C-c ' =.  This new buffer lists all the formulas
for the table at point and provides facilities to edit the references.
...
[[file:~/install/git/Worg/images/bzg/formulas_editor.jpg]]
...
the Emacs lisp function does, you might want to *debbug* the formulas.
