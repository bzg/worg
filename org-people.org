...
I started using Emacs about the same time I've switched to GNU/Linux around
1999.  When people are saying they switched to Emacs because of org-mode, for
me it was the Gnus newsreader, which I'm still using today.

Over the time, I've learned elisp and gotten my hands dirty in several
projects, like EMMS, Gnus, and Circe.  And I'm the author of doc-view, which is
integrated in Emacs 23.  In org-mode, I'm in charge of the linking stuff
between Org and Gnus.

Org has become the most important part of my workflow: if I didn't
org-remember it, it won't be done!

In my free time, I'm trying to do as much crazy stuff as possible: parachuting,
hang gliding, rock climbing, snowboarding, and cooking!  Believe me, the last
thing's the most dangerous.

On my day job, I'm a researcher at the Institute for Software Technology at the
University Koblenz-Landau, where my main interests are MDA and especially model
transformations.
