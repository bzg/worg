...
I am working with Eric Schulte on [[http://orgmode.org/worg/org-contrib/babel/index.php][org-babel]] which aims to extend
...
workflow. Here, org-mode is an organizer (thanks to Bernt Hansen's
terrific how-to) and a laboratory notebook. The org file is structured
...
people (e.g., my tag is :MH:).  In private org files we use FILETAGS to
...
realising how much more powerful it was, plus the vibrant community is
...
{{{person(Pete Phillips,http://www.petephillips.me.uk/images/pete-karen-italy2009_medsize.jp)}}}
...
[[http://,http://www.petephillips.me.uk][Pete Phillips]]
=======
