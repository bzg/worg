...
performance advantage and I was doing a project in an old UNIX
environment where there was no Emacs or even vim: I actually had to
learn vi.

While switching from Emacs to vi(m) I created [[http://karl-voit.at/vim-emacs-cheatsheet_of_freezing_hell.shtml][The vim/emacs cheatsheet
...
generating LaTeX beamer presentations. My mouth stays open until that
day :-)
...
[[http://www.jpilot.org/][J-Pilot]], [[http://en.wikipedia.org/wiki/Sharp_Zaurus][Sharp Zaurus]], Outlook, Desktop-Wikis like [[http://zim-wiki.org/][Zim]] or [[http://www.thebrain.com/][Personal
...
Since 2009 I am writing a PhD thesis in the field of PIM and
Information Architecture. You probably have heard of [[http://tagstore.org][tagstore]] which is
a research software from my project. I am interested in having
something that represents [[http://en.wikipedia.org/wiki/Memex][the old idea of a Memex]] which visualizes
much of my data in a useful way. Therefore I started an extension of
Org-mode which is called [[https://github.com/novoid/Memacs][Memacs]]. Please visit the project page when
you want something easy that integrates *lots* of different data
sources into your Org-mode agenda.
...
properties]]. This is when I started to commit to Worg :-)
