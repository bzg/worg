...
Encountering org-mode motivated me to learn emacs-lisp (which I had
previously found strangely refractory); it's not necessary to program
in order to use org-mode, but the experience of using it becomes even
more impressive when you start modifying it for your personal use. The
...
cities. In the last few years my birding/camping trips have been to
the more remote areas of northern Finland, Romania, Ethiopia and
Panamá.
