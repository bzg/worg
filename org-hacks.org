...
To [[http://en.wikipedia.org/wiki/Transpose][transpose]] this 4x7 table
...
=quote= and show the average change of the time series =(year, quote)=
...
table. The complicated part of the formula without the field blanking is:
