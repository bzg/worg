...
`f-org-table-move-row-in-column-down' and
`f-org-table-move-row-in-column-up' are not yet implemented. To me they seem
more complicated, even with the help of Emacs Rectangles. I suggest to
