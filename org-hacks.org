...
#+END_SRC
  ...
  UTILITIES/org-fixup.el), you can use the definitions below.  To use
...
Sean O'Halpin wrote a minor mode for this, please check it [[https://github.com/seanohalpin/org-link-minor-mode/blob/master/org-link-minor-mode.el][here]].
