...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook   'find-file-hook 'my-org-hidestarsfile-read)
  (add-hook 'before-save-hook 'my-org-hidestarsfile-write)
  (add-hook  'after-save-hook 'my-org-hidestarsfile-read)
#+END_SRC
