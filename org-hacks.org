...
#+index: Compilation!without make
  ...
  org has been unpacked into, in other words the file =default.mk=
  should be found in your current directory.  The command =emacs=
  should be found in your =PATH= and start the Emacs version you are
  using.  To make just the autoloads file do:
