...
The functions
: f-org-table-move-row-in-column-down
: f-org-table-move-row-in-column-up
: f-org-table-rotate-row-in-column-down
: f-org-table-rotate-row-in-column-up
are not yet implemented because they are more complicated.  It could
be done similar to =org-table-cut-region= and
=org-table-paste-rectangle= or with the help of Emacs Rectangles.  An
alternative is to interactively or programmatically simply:
