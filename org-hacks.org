...
Org Capture allows you to quickly store a note. It offers a mechanism
to specify templates for notes. Template have such a high demand in
Emacs that multiple modes exist to manage them. This hack shows you
how to mix the Org Capture template system with those of [[https://github.com/joaotavora/yasnippet][YASnippet]] and [[https://github.com/Kungsgeten/yankpad][Yankpad]].

These template systems work by defining templates that you can expand
from a keyword. In the hack you can use this at your advantage, for
example in
...
we have two snippets that expand the keywords "img_" and "st" of
YASnippet and Yankpad respectively. Wrapping the keyword in
=(ya-org-capture/make-snippet ...)= makes sure to expand the
template. Note these are hybrid snippets (they use Org Capture
syntax), you can also just expand the keywords and have all in there
(I do!).

The syntax above works if you load the Emacs Lisp code in this
repository: https://github.com/ag91/ya-org-capture.
...
describing this more in detail is [[https://ag91.github.io/blog/2020/07/28/how-to-integrate-yasnippet-and-yankpad-with-org-capture/][here]].

Here a snapshot of the code in case the repository becomes
unavailable:
