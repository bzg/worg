...
* What is org-mode?
  ...
  :END:
** Can org do "x"? Does org have "x" feature?
   :PROPERTIES:
...
Before emailing the mailing list to ask whether Org-mode has a
particular feature or setting, please do some homework first:
...
** I think my Org-mode is broken! How do I report a bug?
 ...
 1. Please make sure you are running [[#updating-org][the latest version of emacs]].

 2. Please read [[http://orgmode.org/manual/Feedback.html][this section]] of the manual.
...
** When should I contact the mailing list?
   :PROPERTIES:
