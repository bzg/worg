...
#<<making-sure-org-mode-is-up-to-date>>
...
#<<load-org-after-setting-variables>>
...
#<<blank-line-after-headlines-and-list-items>>
...
headline, then pressing =M-RET= at the end of the line will insert a
...
#<<preserving-faces-during-batch-export>>

Normally, when you export an org file or an agenda view from within
emacs, htmlize will convert your face definitions to css styles,
resulting in an html output that preserves the general look of your
org buffers and agenda views.
...
use a CSS file that contains rich face definitions.  To generate face
definitions for a CSS file based on any faces you are currently using
in Emacs, you can use the following function:

: M-x org-export-htmlize-generate-css RET

If you'd like to get rid of the redundant css styles in your exported
html, then you can bind htmlize-output-type to 'css' for the duration
of the export.
