...
recent release of org-mode the
...
version of org-mode you are using.
   ...
   - The online [[http://orgmode.org/manual/index.html][version of the manual]] corresponds to the most recent
     release.

   - The manual at www.gnu.org (link [[http://www.gnu.org/software/emacs/manual/html_node/org/index.html][here]]) corresponds to the version
     of org-mode released with the latest official Emacs release
     (Emacs 22 and org-mode 4.67d as of February 2009).
