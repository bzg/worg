...
See [[http://mid.gmane.org/87mwq6qtjk.fsf%2540gmail.com][this thread]] (and earlier ones) for a discussion about this.
...
The new beamer introduced a few backwards incompatible changes.  Some
of these are discussed [[file:exporters/beamer/ox-beamer.org::#backwards-compatibility][here]].  If you think the discussion can be
improved, please share your thoughts on the mailing list; better yet,
improve the entry on Worg!

** How can export <my favourite element> as <my favourite environment>
   :PROPERTIES:
   :CUSTOM_ID: filter
   :END:
...
#+index: Export!Filters
   ...
   filters.  You can look at [[http://article.gmane.org/gmane.emacs.orgmode/74876][this example]] on the mailing list.
