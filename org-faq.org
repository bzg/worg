...
- For an expandable outline view of the FAQ, type "m" or click "toggle
  view" (above).

- To search the FAQ, type "s" (basic search) or "o" (occur tree). 

- For a full list of navigation commands, type "?" or click on "Help"
  (above).
