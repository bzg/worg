...
week because of holidays, you could add another condition to the sexp:

: ** Class 7:00pm-9:00pm
: <%%(unless (diary-block 3 9 2009 3 13 2009) 
: (and (= 1 (calendar-day-of-week date)) (diary-block 2 16 2009 4 20 2009)))>

The sexp above would omit Monday during the week of March 9, 2009.

Org-mode now offers a more convenient way to set up a recurring
appointment that lasts for a certain period of time, such as a class.
The function to use is org-diary-class:
...
You can use it in an org-diary-class in a file as follows:

: ** Class 7:00pm-9:00pm
: %%(org-diary-class 2 16 2009 4 20 2009 1 10)

This would give us the same result as the more complex sexp example
above.
