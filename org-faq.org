...
#<<convert-plain-lists-to-headlines>>
   ...
   selecting the region and typing something like =C-u C-- 4 C-x TAB=.
   See [[http://www.emacswiki.org/emacs/DeletingWhitespace][this page]] on the EmacsWiki for more ideas.
