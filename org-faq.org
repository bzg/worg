...
** How do I update the info manual pages to the latest org-mode version?
   ...
   latest version of org-mode?".  This is not a problem if org-mode is
   installed system-wide, which autoimatically takes care of this
   issue!  There are three ways to achieve this:
...
Please see this description for [[http://orgmode.org/worg/org-hacks.html#compiling-org-without-make][compiling org-mode without make]]
several different ways you can install a recent version of org-mode
without using the full build system.
