...
If you encounter corruption issues please identify the root cause as
below:
...
5. Create a minimal org file that reproduces the error in =step 4=.
6. Post a bug-report to =emacs-orgmode@gnu.org=
