...
#+end_src
[Source: Paul Sexton's post on Org-mode mailing list.]
...
click on the "Fonts" tab.  If that is indeed the problem, then either
use a different viewer or install Type1 versions of the problematic
fonts. For more details, see the "PDF export" section of
[[./org-dependencies.html][org-dependencies]].
