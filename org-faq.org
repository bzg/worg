...
** How can I filter the agenda view by category and/or filetags?
   ...
   For instance, while at work, one may want to see only one's
   professional tasks; while away from work, one may want to see only
   one's personal tasks.

   There are a couple of easy methods to accomplish this in org-mode.
   ...
   : C-c a a / work [or a tag shortcut if you are using them]
