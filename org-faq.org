...
#+INFOJS_OPT: view:info toc:nil ftoc:t ltoc:t mouse:underline buttons:0 path:http://orgmode.org/Worg/code/org-info-js/org-info.js
...
** How can I reduce the amount of context shown is sparse trees?
...
** How do I keep current with Org mode developement?
   ...
   1. Select a location to house the Org mode repository (approx. 115
   ...
   4. This is where you configure Org mode with Emacs.  Please refer
      to [[http://orgmode.org/worg/org-tutorials/index.php][Org tutorials]].
   ...
   6. You may need to restart org mode to have the changes take effect
      (if you are not rebooting Emacs.)
...
# Local Variables:
# org-export-html-style: "<link rel=stylesheet href=\"org-faq.css\" type=\"text/css\"> <style type=\"text/css\"> </style>"
# End:
