...
Using a unicorn was originally /Bastien Guerry's/ idea, and his friend
/Christophe Bataillon/ designed the logo for us.  Bastien writes why
he chose a unicorn:
...
[[http://article.gmane.org/gmane.emacs.orgmode/11735][Tim Burt]] made a very compilcated one which is now a treasured
...
free-form timestamps to an item for scheduling. Either of the
following work would work to schedule an item at a particular time:
...
Will appear in the agenda at 10:00am.

#+begin_src 
Day-agenda (W22):
Wednesday  27 May 2009
               8:00...... ----------------
  magicshow:  10:00...... Scheduled:  Get dried ice at the magic store
              12:00...... ----------------
              14:00...... ----------------
              16:00...... ----------------
              18:00...... ----------------
...
To enable this flexibility, however, org-mode scans the entire
headline for time of day notation. A potential problem can
arise if you use inactive timestamps in the headline to note when an
...
Org mode would interpret the time in the inactive timestamp as a time
of day indicator and the entry would appear in your agenda at 12:58.

If you would like to turn off the time-of-day search, you can
configure the variable org-agenda-search-headline-for-time. (In Org
versions >= 6.24.)
