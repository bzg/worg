...
** Can I plot data from a table?
   Yes, you can, using a combination of export and gnuplot.  James TD
   Smith explains how in [[http://article.gmane.org/gmane.emacs.orgmode/7525][this post]].
...
** How can I stop the table editor from creating new lines?
   ...
   horizbntal line instead, do this:
