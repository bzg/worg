...
** How can I set up automatic reminders based on Org information?
  ...
  See [[http://article.gmane.org/gmane.emacs.orgmode/5271][this post]] by N. Dokos on the list. See also Russell Adams's hack in [[file:org-hacks.org::#sec-3_2][org-hacks]].
