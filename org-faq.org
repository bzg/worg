...
** How can I use a stable release version instead of the bleeding edge
   :PROPERTIES:
...
: git checkout -b stable release_7.01f

This creates a new branch "stable" with the state of Org at the moment
of release 7.01f.  You can then run Org from this branch and be sure
to use the stable release while development continues on the master
branch.
...
: git pull
: git branch -D stable
: git checkout -b stable release_7.02
