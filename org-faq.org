...
To be safe, you should also make sure that you do not require any
other =org-...= files in your =.emacs= file before you have set your
org variables, since that will cause org.el to be loaded. So to be
safe, load org files *after* you have set your variables.
