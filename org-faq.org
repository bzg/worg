...
** I don't use git. Can I download bleeding edge .zip and .tar.gz archives?
   ...
   Yes. You can download [[http://orgmode.org][org-latest.zip]] or [[http://orgmode.org/org-latest.tar.gz][org-latest.tar.gz]] of
   Org-mode -- these archives are udpated every day at midnight.
