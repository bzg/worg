...
** How can I get remove timestamps and todo keywords from the exported file?
#<<export-options-remove-timestamps>>

You can place an options line at the top of your file:

: #+OPTIONS: <:nil todo:nil

There is a whole host of options you can set in-buffer or globally.
See [[http://orgmode.org/manual/Export-options.html#Export-options][this section]] of the manual for a full list.
