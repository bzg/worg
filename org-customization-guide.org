...
On this page, we have a list of six settings that you might want to try
first in order to personalize your system.
...
** Six small steps toward a personalized system

*** One: A directory for Org files

Decide about the directory where you will put your basic Org file(s).
Org-files do not have to be in this directory at all, but it is
convenient.  The default is "~/org/", and if this is good enough, just
create the directory.  If not, choose one and put it's path into this
variable

#+begin_src emacs-lisp
(setq org-directory "~/path/to/my/directory")
#+end_src

*** Two: More TODO keywords
...
this right in the file with[fn:fn1:press =C-c C-c= in the line after
changing it]:
...
*** Three: Which tags do you use most?
...
*** Four: Which files are relevant for the agenda?
...
*** Five: Find what you need to see now
...
interface[fn:fn2: =M-x customize-variable RET
org-agenda-custom-commands RET=] to it, it is not too hard.  Everyone
...
*** Six: Capture ideas with predefined templates

Use /remember/ to quickly capture ideas, tasks, and notes.  Add
#+begin_src emacs-lisp
(org-remember-insinuate)
#+end_src
to your setup and populate[fn:fn3: =M-x customize-variable RET
...
frequently in the [[org-customization-survey.org][customization survey]].
...
If you want to become a true power user, seeFIXME for yourself what
some users do.  The Emacs customization system[fn:fn5:=M-x
