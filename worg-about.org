...
You just need to send your requested username to one of the site maintainers:
[[mailto:bzg@gnu.org][Bastien]], [[mailto:jasondunsmore@gmail.com][Jason]], or [[mailto:tec@tecosaur.com][Timothy]]. They'll create an account on [[https://code.orgmode.org][code.orgmode.org]] for
you --- see [[file:worg-git.org][how to use git for Worg]] for more information.
