...
You need to register on https://sr.ht and request to be added to the
https://git.sr.ht/~bzg/worg project.

If you are lost, you can ask [[mailto:tec@tecosaur.com][Timothy]] --- also see [[*How to use git for Worg][How to use git for
Worg]] for more information.
...
1. Create an account on https://sr.ht.

2. Request write access to https://git.sr.ht/~bzg/worg.
