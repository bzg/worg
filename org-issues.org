...
** NEW Effort columnview: Show total in different column
  [2010-09-26 So]
:PROPERTIES:
...
** NEW *.org files showing up as "exec" files in Snow Leopard
  [2010-09-26 So]
:PROPERTIES:
...
** NEW (PATCH) Always run org-insert-heading-hook when creating headlines
  [2010-09-26 So]
:PROPERTIES:
