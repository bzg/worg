...
** NEW (BUG)(Babel) Exporting text before heading                                            :Babel:
  [2010-07-16 Fr]
  :PROPERTIES:
...
** NEW Problem when org-capturing text from French email
  [2010-07-16 Fr]
  :PROPERTIES:
...
** BUG Bug: org-timer-start with offset (6.36trans)
  [2010-07-17 Sa]
  :PROPERTIES:
...
** NEW Fwd: (Orgmode) Re: auto-fill in a body often insert a space?
  [2010-07-18 So]
  :PROPERTIES:
...
** NEW (Patch) Capture: [Error: (void-function FILE)] and %![Error: (void-function SEXP)] (again)%!
  [2010-07-18 So]
  :PROPERTIES:
...
*** BUG inline image display not working when org-indent-mode active
  [2010-07-18 So]
  :PROPERTIES:
...
*** IDEA Insert ellipsis if headline is too long
  [2010-07-13 Di]
  :PROPERTIES:
