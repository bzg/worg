...
** NEW Export of quoted region to HTML
  [2010-12-19 So]
:PROPERTIES:
...
** NEW xemacs error when calling org-install                                                                                                 :Xemacs:
  [2010-12-19 So]
:PROPERTIES:
...
** NEW (Babel) The first line of the code blocks disappears in the tangled file
  [2010-12-19 So]
:PROPERTIES:
...
** NEW Bug: capture with PROPERTIES (7.3 commit-972b0a58...)
  [2010-12-19 So]
:PROPERTIES:
