...
** NEW bug in the :VISIBILITY: handling of nested "folded" properties?
  [2010-07-31 Sa]
:PROPERTIES:
...
** INCONSISTENCY is it a bug in org-capture
:LOGBOOK:
...
** NEW Org-indent-mode (lack of) support for plain list
  [2010-08-01 So]
:PROPERTIES:
...
** NEW (ANN) Org-Drill: Interactive revision a la Anki/Mnemosyne
  [2010-08-01 So]
:PROPERTIES:
...
** NEW Tracking finances with Babel                                                          :Babel:
  [2010-08-02 Mo]
:PROPERTIES:
...
** NEW MathJax - use Tex/LaTeX/MathML in HTML pages
  [2010-08-02 Mo]
:PROPERTIES:
...
** NEW (Babel) gnuplot, table entry and temporary file                                       :Babel:
  [2010-08-02 Mo]
:PROPERTIES:
...
** NEW (babel) Error Before first headline.%!                                                :Babel:
  [2010-08-04 Mi]
:PROPERTIES:
...
** QUESTION babel versionitis?%!                                                             :Babel:
:LOGBOOK:
...
** NEW camel.el, for CamelCase links%!
  [2010-08-04 Mi]
:PROPERTIES:
...
** QUESTION Babel - display results in an overlay?%!
:LOGBOOK:
- State "QUESTION"   from "NEW"        [2010-08-04 Mi 20:14]
:END:
  [2010-08-04 Mi]
...
** BUG Problem when exporting to PDF to a different directory%!
:LOGBOOK:
...
** NEW (PATCH) Mode-specific fontification of babel source blocks%!                          :Patch:
  [2010-08-04 Mi]
:PROPERTIES:
...
** QUESTION How to change plain text face in Org Mode?%!
:LOGBOOK:
...
** QUESTION bug in dynamic block for clock table using :tags%!
:LOGBOOK:
- State "QUESTION"   from "NEW"        [2010-08-04 Mi 20:19]
:END:
  [2010-08-04 Mi]
...
** QUESTION Change resolution of LaTeX formulas in HTML output?%!
:LOGBOOK:
...
** QUESTION How can I add a DONE tag to an org file?
:LOGBOOK:
- State "QUESTION"   from "NEW"        [2010-08-02 Mo 18:56]
:END:
  [2010-08-02 Mo]
...
** QUESTION question about org-agenda-files
:LOGBOOK:
