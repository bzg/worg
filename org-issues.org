...
** NEW Verbatim LaTeX inside delimiters in HTML export with jsMath?
  [2010-06-18 Fr]
  :PROPERTIES:
...
** NEW Possible bug in ordered tasks
  [2010-06-19 Sa]
  :PROPERTIES:
...
** NEW Writing the words in different color
  [2010-06-22 Di]
  :PROPERTIES:
