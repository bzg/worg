...
** NEW (Orgmode) Bug: lists, maths and export to latex
  [2010-06-13 So]
  :PROPERTIES:
...
** NEW (Orgmode) org-plot file export options
  [2010-06-13 So]
  :PROPERTIES:
...
** Exporting
*** IDEA [Orgmode] Could inline footnotes be made to work with latex commands that have arguments?
  [2010-06-09 Mi]
  :PROPERTIES:
