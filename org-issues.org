...
** NEW How can I just publish entry marked as DONE?
  [2010-10-15 Fr]
:PROPERTIES:
...
** NEW entities and removing some markup in ascii export
  [2010-10-15 Fr]
:PROPERTIES:
...
** NEW Option to prevent auto-insertion of blank lines by M-return?
  [2010-10-15 Fr]
:PROPERTIES:
...
** NEW Feature idea: overwrite time at the prompt when rescheduling
  [2010-10-15 Fr]
:PROPERTIES:
...
** NEW library of babel, bootabs question
  [2010-10-15 Fr]
:PROPERTIES:
...
** NEW how to reverse a region of outline items
  [2010-10-15 Fr]
:PROPERTIES:
...
** NEW bug with respect to org-read-date-prefer-future
  [2010-10-15 Fr]
:PROPERTIES:
...
** NEW org tbl, sum elements in a colum with the mouse
  [2010-10-16 Sa]
:PROPERTIES:
...
** NEW Bug: No match - create this as a new heading? (7.01trans)
  [2010-10-16 Sa]
:PROPERTIES:
...
** NEW Recurring scheduled items appearing in schedule
  [2010-10-16 Sa]
:PROPERTIES:
...
** NEW configuring Org agenda faces by priority
  [2010-10-16 Sa]
:PROPERTIES:
...
** NEW column view: "local" doesn't seem to work for me
  [2010-10-16 Sa]
:PROPERTIES:
...
** NEW Ampersands in OrgTbl to HTML
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Need help publishing subdirectories
  [2010-10-17 So]
:PROPERTIES:
...
** NEW puzzling plain list and tree folding behaviour
  [2010-10-17 So]
:PROPERTIES:
...
** NEW optimal usage Q : how would you do this?
  [2010-10-17 So]
:PROPERTIES:
...
** NEW (PATCH) Fix broken internal links on export                                          :Patch:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Latex-Export with custom commands
  [2010-10-17 So]
:PROPERTIES:
...
** NEW org-publish fails to export the #anchor in other_org_file.html#anchor
  [2010-10-17 So]
:PROPERTIES:
...
** NEW org-mobile-use-encryption                                                            :Mobile:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Any other Aquamacs + org-mode users?
  [2010-10-17 So]
:PROPERTIES:
...
** NEW org-publish with latest changes?
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Lisp error: (wrong-type-argument stringp nil)
  [2010-10-17 So]
:PROPERTIES:
...
** NEW (BUG) OrgTbl exports raw ampersands in HTML
  [2010-10-17 So]
:PROPERTIES:
...
** NEW org-mobile agenda failure with encryption and tramp                                  :Mobile:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW org-mode and claws
  [2010-10-17 So]
:PROPERTIES:
:ID: mid:4CB6057F%2E3080808%40sym%2Enet
:END:

    - Gmane :: [[http://news.gmane.org/find-root.php?message_id=4CB6057F%2E3080808%40sym%2Enet][org-mode and claws]]

** NEW Elementary: How to return to the main view
  [2010-10-17 So]
:PROPERTIES:
...
** NEW (Babel) Debugging shell code that misbehaves                                         :Babel:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW 7.01h problems under Xemacs 21.4.X: submit bug report does not work
  [2010-10-17 So]
:PROPERTIES:
...
** NEW org-insert-heading and inline tasks
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Bug: Export header-level list inconsistency
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Using \ref instead of \hyperref in LaTeX export?
  [2010-10-17 So]
:PROPERTIES:
...
** NEW (Testing + Babel) Old Org HTML hides Org HTML
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Weird behaviour with org-yank and org-startup-indented
  [2010-10-17 So]
:PROPERTIES:
...
** NEW (Babel) Marker does not point anywhere (when session buffer needs to be created)     :Babel:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Enhancing the Org/Gnus experience
  [2010-10-17 So]
:PROPERTIES:
...
** NEW question: how to refile labeled with origin?
  [2010-10-17 So]
:PROPERTIES:
...
** NEW #+CATEGORY missing from main index of online documentation?
  [2010-10-17 So]
:PROPERTIES:
...
** NEW mobileorg app can't sync                                                             :Mobile:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW (Babel) Library calls and begin_example                                              :Babel:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW command-name org-insert-heading-respect-content                                      :Patch:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW How do I change when a new day starts in orgmode?
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Tiny piece of customization for ctrl-c ctrl-c within a timestamp
  [2010-10-17 So]
:PROPERTIES:
...
** NEW (babel) Links in tangled file - howto jump to .org?                                  :Babel:
  [2010-10-17 So]
:PROPERTIES:
...
** NEW Publishing bug: FOOTNOTE DEFINITION NOT FOUND: 0
  [2010-10-17 So]
:PROPERTIES:
...
** NEW VISIBILITY property and C-u C-u <TAB>
  [2010-10-18 Mo]
:PROPERTIES:
...
** NEW suggesting a new function org-export-string                                          :Patch:
  [2010-10-18 Mo]
:PROPERTIES:
...
** NEW How to set todo-dependencies for specific org file?
  [2010-10-18 Mo]
:PROPERTIES:
...
** NEW Unable to export babel results                                                       :Babel:
  [2010-10-18 Mo]
:PROPERTIES:
