...
*** WAITING Rewrite of org-indent-mode                                   :Patch:
:LOGBOOK:
...
**** WAITING Org-indent-mode (lack of) support for plain list
:LOGBOOK:
...
**** WAITING Linum-mode + org-indent-mode gives strange graphical refresh bugs (7.4 (release_7.4.41.g96c70))
:LOGBOOK:
