...
*** INCONSISTENCY Odd Ido interaction (7.01trans)
:LOGBOOK:
...
*** INCONSISTENCY Linum-mode + org-indent-mode gives strange graphical refresh bugs (7.4 (release_7.4.41.g96c70))
:LOGBOOK:
...
*** BUG Quotes-in-strings not being escaped in python, breaking output   :Babel:
    :LOGBOOK:
...
*** WAITING Changing TODO states sometimes modifies the scheduling of the next heading
   :LOGBOOK:
