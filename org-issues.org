...
** WAITING org-faq: Invalid XHTML                                                                                                                                                                                                 :Patch:
:LOGBOOK:
...
** NEW Bug: UTF-8 characters in #+LINK does not work (7.4)
  [2011-01-30 So]
:PROPERTIES:
...
** NEW latex table export not centered
  [2011-01-30 So]
:PROPERTIES:
...
** NEW (BUG/PATCH) Set fill-indent-according-to-mode to nil in Org buffers
  [2011-01-30 So]
:PROPERTIES:
...
** NEW HTML export and absolute file names
  [2011-02-24 Do]
:PROPERTIES:
