...
** NEW exec code on task state progression
  [2010-08-21 Sa]
:PROPERTIES:
...
** NEW Gnuplot unevenly spaced non-numeric data plot?
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW (org-babel) References Not Expanding                                           :Babel:Patch:
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW mathjax HTML export question
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW Folding org drawers in elisp code?
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW From state table to state diagram
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW Bug: habit: better error handling required (TAG=7.01g)
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW Mark days in calendar based on agenda
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW (babel) support plantuml                                                             :Babel:
  [2010-08-25 Mi]
:PROPERTIES:
...
** NEW (babel) babel creating corrupt pdf and png                    :Babel:
  [2010-08-29 So]
:PROPERTIES:
...
** NEW (Ann) Updates to org-drill (org topics as interactive "flashcards" using spaced repetition)
  [2010-08-29 So]
:PROPERTIES:
...
** NEW Error during Publishing to HTML
  [2010-08-29 So]
:PROPERTIES:
...
** NEW Examples in numbered lists
  [2010-08-29 So]
:PROPERTIES:
...
** NEW (babel) ledger tutorial on Worg
  [2010-08-29 So]
:PROPERTIES:
...
** NEW org-table: Table Navigation esp. for multi-line cells?
  [2010-08-29 So]
:PROPERTIES:
...
** NEW Bug: escaping a star in a heading (7.01trans)
  [2010-08-29 So]
:PROPERTIES:
...
** NEW org-capture loses entered text when C-g on file selection
  [2010-08-29 So]
:PROPERTIES:
...
:END:
    ...
    - Gmane :: [[http://news.gmane.org/find-root.php?message_id=AANLkTikw3%3Ds%2BvHyKcEN5SnEi4J6qMRpQ%5FLVsxLuDsqyy%40mail%2Egmail%2Ecom][startup in column view]]
** DONE Browsing worg
