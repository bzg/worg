...
** NEW magit, revert, folding, normal-mode, performance
  [2010-06-27 So]
  :PROPERTIES:
...
** NEW Proposed tweak to org-agenda-skip-entry-when-regexp-matches-in-subtree
  [2010-06-28 Mo]
  :PROPERTIES:
...
** NEW Org-capture - go to last captured note is not consistent
  [2010-06-28 Mo]
  :PROPERTIES:
...
** NEW org-babel and emacs init                                                              :Babel:
  [2010-06-28 Mo]
  :PROPERTIES:
...
** NEW Exporting narrowed subtrees to HTML                                                   :Patch:
  [2010-06-30 Mi]
  :PROPERTIES:
...
** NEW org2blog - blog from org-mode to wordpress
  [2010-06-30 Mi]
  :PROPERTIES:
...
** NEW Google calendar to org mode script and a feature request for agenda
  [2010-06-30 Mi]
  :PROPERTIES:
...
** NEW Org-jekyll - org-publish-initialize-files-alist
  [2010-06-30 Mi]
  :PROPERTIES:
...
** NEW (babel) Evaluating all source blocks in a document?                                   :Babel:
  [2010-07-01 Do]
  :PROPERTIES:
...
** NEW org-capture file+function match (PATCH) + question
  [2010-07-01 Do]
  :PROPERTIES:
...
** NEW org-capture: active timestamp in template doesn't seem to work
  [2010-07-01 Do]
  :PROPERTIES:
...
** NEW Bug: #+ATTR_LaTeX broken in LaTeX export (6.36trans (release_6.36.461.g798e))
  [2010-07-01 Do]
  :PROPERTIES:
...
** NEW (BABEL) html export for R not working, but for sh and others                          :Babel:
  [2010-07-01 Do]
  :PROPERTIES:
...
** NEW problem in highlighting fields in a remote table
  [2010-07-01 Do]
  :PROPERTIES:
...
** IDEA Re: (Orgmode) (org-babel) Does org-babel needs some simplification?
  [2010-07-01 Do]
  :PROPERTIES:
...
#+END_QUOTE
** WISH (PATCH) add firefox/vimperator support to contrib/lisp/org-mac-link-grabber.el
  [2010-07-01 Do]
  :PROPERTIES:
...
** QUESTION (org-babel) Does org-babel needs some simplification?                            :Babel:
  [2010-06-30 Mi]
  :PROPERTIES:
...
** QUESTION Supress Contents frame in LaTeX beamer export
  [2010-06-30 Mi]
  :PROPERTIES:
...
** QUESTION inline tasks (org-inlinetask.el)
  [2010-06-30 Mi]
  :PROPERTIES:
...
** QUESTION mobileorg - "No executable found to compute checksums"
  [2010-06-30 Mi]
  :PROPERTIES:
...
** QUESTION LaTeX export works but not in HTML
  [2010-06-30 Mi]
  :PROPERTIES:
...
** QUESTION org-capture: Formatting of entries
  [2010-06-30 Mi]
  :PROPERTIES:
...
** QUESTION Literal examples and indentation
  [2010-07-01 Do]
  :PROPERTIES:
...
** QUESTION complex filters in agenda view
  [2010-06-27 So]
  :PROPERTIES:
...
** QUESTION Headline and numbered plain list
  [2010-06-28 Mo]
  :PROPERTIES:
...
** QUESTION Behavior of Gnus when called from an hyperlink
  [2010-06-28 Mo]
  :PROPERTIES:
...
*** BUG Org ident destroys special fontification of inline tasks
  [2010-06-13 So]
  :PROPERTIES:
...
*** BUG Bug: org.texi doesn't compile (6.36trans (release_6.36.415.gb2dcd))
  [2010-06-27 So]
  :PROPERTIES:
...
*** BUG Bug: org-capture destroys target file when user aborting prompt in template (6.36trans (release_6.36.430.gec51))
  [2010-06-27 So]
  :PROPERTIES:
