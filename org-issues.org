...
** WISH error navigating the agenda "org-agenda-earlier"
:LOGBOOK:
...
** INCONSISTENCY (PATCH) Markup on same line as text
:LOGBOOK:
...
** WISH Re: (Orgmode)(PATCH) How do I include text between a range of line numbers with #INCLUDE                                                                                                                                  :Patch:
:LOGBOOK:
