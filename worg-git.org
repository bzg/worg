...
* TODO Describe how worg publishes itself as HTML?              :Write:

  Bastien, can you possibly write a step 10 here which explains how
  Worg is published as html from the git repo onto legito.net?
