...
2. Register a [[http://repo.or.cz/m/reguser.cgi][new account]] on the git public repository.  Your login
   here should be the same as the user name on your own computer.

3. Drop an email to [[mailto:bzg%20AT%20altern%20DOT%20org][Bastien]] mentioning your user name on repo.or.cz.
