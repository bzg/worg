...
Nicolas Goaziou is take care of org-element.el and most of the
exporters.
...
release.  He also hosts the [[https://public-inbox.org/README.html][public-inbox]] of the mailing list at
[[https://list.orgmode.org][list.orgmode.org]].

Timothy (aka "TEC") and Tim Cross are contributor stewards: they 
make sure that all contributions get the attention they deserve.

John Corless is helping with confirming reported bugs.

Some file have a dedicated maintainer: just grep ";; Maintainer" 
in the Org repository to find them.  If you use a specific file
heavily and speak Elisp, please consider becoming a maintainer
or [[file:org-contribute.org][contributing]] in general.
...
Bug fixes always go on =bugfix= then are merged on =main=.
