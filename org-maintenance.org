...
The maintainer of an Org file takes care of bug reports and feature
requests against this file.  He can push changes with no permission.
In case the change touches files maintained by others, they need to
review and validate it first.  If Org's maintainer disagrees with a
change, he can ask the maintainers to revert it.
