...
3. Push your topic branches (and optionally the master branch) to your
   ...
   Define a remote for your public respository you push topics to.
...
6. Develop your feature on the topic branch.  It is very helpful if
   ...
   the current orgigin/master is.  There are two alternative ways to
   achieve this:
   ...
   - *or* keep your branch on top of origin/master by regularly using 
      ...
      to pull all the changes made in origin/mastere _underneath_ our
      own changes.
...
8. When the patch is accepted, I ask you to once again to make sure
   ...
   Emacs-style /ChangeLog/ files I can of cause fix while I am doing
   the merge.
