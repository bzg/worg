...
In even more explicit terms: By submitting patches to
emacs-orgmode@gnu.org, or by pushing changes to the Org-mode
repository, you are placing these changes under GPL version 3, with
all the implications that has.  If at the time you submit or push
these changes you have active copyright assignment papers with the
FSF, for future changes to either Org-mode or to Emacs, this means
that copyright to these changes is automatically transferred to the
FSF.  The Org-mode repository is seen as upstream repository for
Emacs, anything contained in it can potentially end up in Emacs.  If
you do not have signed papers with the FSF, only changes to files in
the contrib/ part of the repository will be accepted, and you will be
asked to sign FSF papers at the moment we attempt to move the file
...
39. Feng Shu
40. Gary Oberbrunner
41. George Kettleborough
42. Giovanni Ridolfi
43. Grégoire Jadi (aka Daimrod)
44. Henning Dietmar Weiss
45. Ian Barton
46. Ilya Shlyakhter
47. Ippei Furuhashi
48. James TD Smith
...
50. Jarmo Hurri
51. Jason Riedy
52. Jeffrey Ryan Horn
53. Joel Boehland
54. John Wiegley
55. Jonas Bernoulli
56. Jonathan Leech-Pepin
57. Juan Pechiar
58. Julian Gehring
59. Julien Barnier
60. Julien Danjou
61. Justus Piater
62. Konstantin Antipin
63. Lawrence Mitchell
64. Le Wang
65. Lennart Borgman
66. Luis Anaya
67. Lukasz Stelmach
68. Madan Ramakrishnan
69. Magnus Henoch
70. Manuel Giraud
71. Martin Pohlack
72. Martyn Jago
