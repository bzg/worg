...
- You can *fix bugs*: check [[https://updates.orgmode.org/][updates.orgmode.org]] for confirmed bugs.

- You can try to *reproduce bugs*: subscribe to [[https://lists.gnu.org/mailman/listinfo/emacs-orgmode][Org's mailing list]] and
  monitor new bugs.  For new ones, try to reproduce them.  If you can
...
- You can *send bug reports*.

  Before sending a bug report, make sure you have read the [[https://orgmode.org/org.html#Feedback][Feedback]]
  section of Org's manual or this other great text: [[http://www.chiark.greenend.org.uk/~sgtatham/bugs.html][How to Send Bug
  Reports Effectively]]
...
- You can *share ideas and feature requests*.  Org is already mature,
  ...
  first dig into the mailing list to find similar proposals.  If you
