...
- You can check our *requests for help* on [[https://updates.orgmode.org/][updates.orgmode.org]] and
  subscribe to [[https://updates.orgmode.org/feed/help][this RSS feed]].
...
- You can *write add-ons*. The best way is to submit your code to [[file:org-mailing-list.org][the
  ...
  [[*Copyright issues when contributing to Emacs Org mode][assignment contract with the FSF]], we might include your contribution 
