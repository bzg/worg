...
Either choice would be fine, of course, but here are a few things to
keep in mind when you make your choice:
...
an org-mode file, TODO Keywords are highly visible, tags somewhat less
so, and properties not at all.
