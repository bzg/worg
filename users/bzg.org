...
[[http://orgmode.org/index.html][{Back to Worg's index}]]
...
- [[http://orgmode.org/worg/org-tutorials/org-column-screencast.html][Org Column screencast]]
- [[http://orgmode.org/worg/org-tutorials/org-column-view-tutorial.html][Org Column Tutorial]]
- [[http://orgmode.org/worg/org-tutorials/org-spreadsheet-intro.html][Introduction to Org spreadsheet system]]
- [[http://orgmode.org/worg/org-tutorials/orgtutorial_dto-fr.html][Translation of David O'Toole tutorial]]
- [[http://orgmode.org/worg/org-tutorials/tables.html][Introduction to tables in Org]]
...
implemented in various ways.  Context can be set as a [[http://orgmode.org/manual/Tags.html][tag]], a [[http://orgmode.org/manual/Categories.html][category]],
or any other [[http://orgmode.org/manual/Properties-and-Columns.html][property]] of an item: you can then easily narrow your org
...
check out this [[http://orgmode.org/worg/org-tutorials/advanced-searching.html][great documentation page]] by Matt Lundin.
