...
plain-text files.  It seamlessly integrates all your notes, mindmaps, TODO
lists, calendar, day planner, and project schedules into a single system
that can be easily searched (e.g. by grep), encrypted (e.g. by [[http://www.gnupg.org/][GnuPG]]),
backed up and synced (e.g.  by Dropbox), imported/exported, and accessed on
...
- Translations of the orgcard in french ([[file:code/latex/fr-orgcard.tex][tex]] - [[file:images/bzg/fr-orgcard.pdf][pdf]]).
