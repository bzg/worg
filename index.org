...
See [[http://thread.gmane.org/gmane.emacs.orgmode/31506/focus%3D31794][start of the discussion]].
...
#+BEGIN_HTML
<script language="JavaScript" src="http://itde.vccs.edu/rss2js/feed2js.php?src=http://repo.or.cz/w/Worg.git?a=rss&chan=n&num=10&desc=0&date=n&targ=n" type="text/javascript"></script>
#+END_HTML
