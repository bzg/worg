...
Letter metadata set in LCO files overwrites [[*Setting letter meta data in Emacs variables][letter metadata set in
Emacs variables]] but not [[*Setting letter meta data in Org option lines][letter metadata set in the Org file]].
