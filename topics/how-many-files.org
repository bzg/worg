...
*Bottom line: Use whatever combination of small and large files that works for you.*

It's not uncommon for Org users to have relatively large files with tens or even hundreds of thousands of lines, accumulated over many years.
